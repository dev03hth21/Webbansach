...
namespace SachOnline.Models
{
	...
	public partial class SACH : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<CHITIETDATHANG> _CHITIETDATHANGs1;
		...
		private EntityRef<CHUDE> _CHUDE1;
    ...
    partial void OnMoTaChanged();
		...
		public SACH()
		{
			...
			this._CHITIETDATHANGs1 = new EntitySet<CHITIETDATHANG>(new Action<CHITIETDATHANG>(this.attach_CHITIETDATHANGs1), new Action<CHITIETDATHANG>(this.detach_CHITIETDATHANGs1));
			...
			this._CHUDE1 = default(EntityRef<CHUDE>);
		...
		public System.Nullable<int> MaCD
		{
			...
			set
			{
				if ((this._MaCD != value))
				{
					if ((this._CHUDE.HasLoadedOrAssignedValue || this._CHUDE1.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SACH_CHITIETDATHANG1", Storage="_CHITIETDATHANGs1", ThisKey="MaSach", OtherKey="MaSach")]
		public EntitySet<CHITIETDATHANG> CHITIETDATHANGs1
		{
			get
			{
				return this._CHITIETDATHANGs1;
			}
			set
			{
				this._CHITIETDATHANGs1.Assign(value);
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CHUDE_SACH1", Storage="_CHUDE1", ThisKey="MaCD", OtherKey="MaCD", IsForeignKey=true)]
		public CHUDE CHUDE1
		{
			get
			{
				return this._CHUDE1.Entity;
			}
			set
			{
				CHUDE previousValue = this._CHUDE1.Entity;
				if (((previousValue != value) 
							|| (this._CHUDE1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CHUDE1.Entity = null;
						previousValue.SACHes1.Remove(this);
					}
					this._CHUDE1.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("CHUDE1");
				}
			}
		}
		...
		private void attach_CHITIETDATHANGs1(CHITIETDATHANG entity)
		{
			this.SendPropertyChanging();
			entity.SACH1 = this;
		}
		
		private void detach_CHITIETDATHANGs1(CHITIETDATHANG entity)
		{
			this.SendPropertyChanging();
			entity.SACH1 = null;
		}
    ...
    partial void OnDonGiaChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SACH_CHITIETDATHANG1", Storage="_SACH1", ThisKey="MaSach", OtherKey="MaSach", IsForeignKey=true)]
		public SACH SACH1
		{
			get
			{
			...
			set
			{
							...
							|| (this._SACH1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CHITIETDATHANGs1.Remove(this);
					}
					this._SACH1.Entity = value;
					if ((value != null))
					{
						value.CHITIETDATHANGs1.Add(this);
						this._MaSach = value.MaSach;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DONDATHANG_CHITIETDATHANG1", Storage="_DONDATHANG1", ThisKey="MaDonHang", OtherKey="MaDonHang", IsForeignKey=true)]
    ...
    partial void OnTenChuDeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CHUDE_SACH1", Storage="_SACHes1", ThisKey="MaCD", OtherKey="MaCD")]
    ...
    partial void OnMaKHChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DONDATHANG_CHITIETDATHANG1", Storage="_CHITIETDATHANGs1", ThisKey="MaDonHang", OtherKey="MaDonHang")]
		public EntitySet<CHITIETDATHANG> CHITIETDATHANGs1
		{
			get
			{
    ...
    partial void OnMetaTitleChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TenTrang", DbType="NVarChar(100)")]
