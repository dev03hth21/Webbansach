...
namespace SachOnline.Controllers
{
    public class SachOnlineController : Controller
    {
        ...
        public ActionResult SachTheoChuDe(int id, int? page)
        {
            ...
            var sach = data.SACHes.Where(s => s.MaCD == id).OrderByDescending(s => s.NgayCapNhat).ToPagedList(pageNumber, pageSize);
        ...
        public ActionResult SachTheoNhaXuatBan(int id, int? page)
        {
            ...
            var sach = data.SACHes.Where(s => s.MaNXB == id).OrderByDescending(s => s.NgayCapNhat).ToPagedList(pageNumber, pageSize);
